...
public class UserQuerier : IUserQuerier
{
  ...
  public UserQuerier(IdentityContext context, IMapper mapper, IQueryHelper queryHelper)
  {
    _mapper = mapper;
  ...
  {
    IQueryBuilder builder = _queryHelper.From(Db.Users.Table).SelectAll(Db.Users.Table);
    builder = _queryHelper.ApplyTextSearch(builder, payload.Id, Db.Users.AggregateId);
    builder = _queryHelper.ApplyTextSearch(builder, payload.Search, Db.Users.UniqueName,
      Db.Users.AddressFormatted, Db.Users.EmailAddress, Db.Users.PhoneE164Formatted, Db.Users.FullName);
    builder = _queryHelper.ApplyTextSearch(builder, payload.TenantId, Db.Users.TenantId);
