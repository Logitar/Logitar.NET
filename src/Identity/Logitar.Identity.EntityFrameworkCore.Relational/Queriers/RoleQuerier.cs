...
public class RoleQuerier : IRoleQuerier
{
  ...
  public RoleQuerier(IdentityContext context, IMapper mapper, IQueryHelper queryHelper)
  {
    _mapper = mapper;
  ...
  {
    IQueryBuilder builder = _queryHelper.From(Db.Roles.Table).SelectAll(Db.Roles.Table);
    builder = _queryHelper.ApplyTextSearch(builder, payload.Id, Db.Roles.AggregateId);
    builder = _queryHelper.ApplyTextSearch(builder, payload.Search, Db.Roles.UniqueName, Db.Roles.DisplayName);
    builder = _queryHelper.ApplyTextSearch(builder, payload.TenantId, Db.Roles.TenantId);
