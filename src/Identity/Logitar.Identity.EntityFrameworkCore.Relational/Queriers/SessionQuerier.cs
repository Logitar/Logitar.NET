...
public class SessionQuerier : ISessionQuerier
{
  ...
  public SessionQuerier(IdentityContext context, IMapper mapper, IQueryHelper queryHelper)
  {
    _mapper = mapper;
  ...
  public async Task<SearchResults<Session>> SearchAsync(SearchSessionPayload payload, CancellationToken cancellationToken)
  {
    ...
    builder = _queryHelper.ApplyTextSearch(builder, payload.Id, Db.Sessions.AggregateId);
    builder = _queryHelper.ApplyTextSearch(builder, payload.TenantId, Db.Users.TenantId);
    builder = _queryHelper.ApplyTextSearch(builder, payload.UserId, Db.Users.AggregateId);
