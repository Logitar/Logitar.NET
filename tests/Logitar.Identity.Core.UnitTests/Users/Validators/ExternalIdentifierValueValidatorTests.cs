...
public class ExternalIdentifierValueValidatorTests
{
  private readonly Bogus.Faker _faker = new();

  private readonly ExternalIdentifierValueValidator _validator = new();

  [Theory(DisplayName = "It should use the specified property name.")]
  [InlineData("__ExternalIdentifierValue__")]
  public void It_should_use_the_specified_property_name(string propertyName)
  {
    ExternalIdentifierValueValidator validator = new(propertyName);
